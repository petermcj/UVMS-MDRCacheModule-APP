...
4. You will be presented with options from your local artifact repo. Chose the one that have the namespace  "eu.europa.ec.fisheries.uvms.mdr.eu.europa.ec.fisheries.uvms.mdr europa.ec.fisheries.uvms.movement:movement-archetype"
5. Define value for property 'groupId': : eu.europa.ec.fisheries.uvms.mdr.eu.europa.ec.fisheries.uvms.mdr europa.ec.fisheries.uvms.YOUR_COMPONENT_NAME
...
8. Define value for property 'package':  eu.europa.ec.fisheries.uvms.mdr.eu.europa.ec.fisheries.uvms.mdr europa.ec.fisheries.uvms.YOUR_COMPONENT_NAME: : eu.europa.ec.fisheries.uvms.mdr.eu.europa.ec.fisheries.uvms.mdr europa.ec.fisheries.uvms.YOUR_COMPONENT_NAME
