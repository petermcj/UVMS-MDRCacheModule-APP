...
public class AbstractMessageProducer {
	     ...
	     */
	    protected String sendMessage(Destination toQueue, Destination responseQueue, String textMessag, int deliveryMode, int defultPriority, long timeToLive) throws MdrMessageException {
	     ...
	     * @throws MovementMessageException
	     */
	    protected String sendMessage(Destination responseQueue, String textMessage, String correlationId) throws MdrMessageException {
	     ...
	     * @throws MovementMessageException
	     */
	    protected String sendMessage(Destination toQueue, Destination replyQueue, String textMessage) throws MdrMessageException {
	     ...
	     * @throws MovementMessageException
	     */
	    private String sendMessage(Destination toQueue, Destination replyQueue, String textMessage, String correlationId, Integer deliveryMode, Integer defaultPriority, Long timetoLive) throws MdrMessageException {
	        ...
	        try {
	            ...
	            throw new MdrMessageException("Error when sending message or closing JMS queue", ex);
	        }
	    }
