 ...
 */
@Entity
@Table(name = "mdr_sale_br")
@Indexed
public class SaleBr extends MasterDataRegistry {
    private static final long serialVersionUID = 1L;

    @Id
    @Column(name = "id", unique = true, nullable = false)
    @SequenceGenerator(name = "SEQ_GEN", sequenceName = "mdr_sale_br_seq", allocationSize = 1)
    ...
    public void populate(MDRDataNodeType mdrDataType) throws FieldNotMappedException {
        ...
        for (MDRElementDataNodeType field : mdrDataType.getSubordinateMDRElementDataNodes()) {
            ...
            if (StringUtils.equalsIgnoreCase(fieldName, "SALE_BR_DEF.CODE")) {
                this.setCode(fieldValue);
            } else if (StringUtils.equalsIgnoreCase(fieldName, "SALE_BR_DEF.ENDESCRIPTION")) {
                this.setDescription(fieldValue);
            } else if (StringUtils.equalsIgnoreCase(fieldName, "SALE_BR_DEF.FIELD")) {
            ...
            } else if (StringUtils.equalsIgnoreCase(fieldName, "SALE_BR_DEF.BRLEVELFK_X_KEY")) {
            ...
            } else if (StringUtils.equalsIgnoreCase(fieldName, "SALE_BR.ACTIVEIND")) {
                this.setActivationIndicator(fieldValue);
            } else if (StringUtils.equalsIgnoreCase(fieldName, "SALE_BR.CONTEXT")) {
