...
public class MdrMapperTest {
    ...
    public void testIndexRequestCreation(){
        ...
        final SetFLUXMDRSyncMessageRulesRequest unmarshalled = JAXBMarshaller.unMarshallMessage(index, SetFLUXMDRSyncMessageRulesRequest.class);
    ...
    public void testCreationOfUpdateRequest(){
        ...
        for(String actualAcronym : existingAcronymsList){
            ...
            SetFLUXMDRSyncMessageRulesRequest unmarshalledReq = JAXBMarshaller.unMarshallMessage(req, SetFLUXMDRSyncMessageRulesRequest.class);
    ...
    public void testCreationOfStructureServiceRequest(){
        ...
        final SetFLUXMDRSyncMessageRulesRequest unmarshalled = JAXBMarshaller.unMarshallMessage(request, SetFLUXMDRSyncMessageRulesRequest.class);
